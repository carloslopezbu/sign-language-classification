...
import numpy as np
import torch
from blazebase import denormalize_detections, resize_pad
...
if back_detector:
    face_detector.load_weights("./models/mediapipe/blazes/blazefaceback.pth")
    face_detector.load_anchors("./models/mediapipe/anchors/anchors_face_back.npy")
else:
    face_detector.load_weights("./models/mediapipe/blazes/blazeface.pth")
    face_detector.load_anchors("./models/mediapipe/anchors/anchors_face.npy")
...
face_regressor.load_weights("./models/mediapipe/blazes/blazeface_landmark.pth")
