...
from visualization import POSE_CONNECTIONS, draw_detections, draw_landmarks, draw_roi
...
pose_detector.load_weights("./models/mediapipe/blazes/blazepose.pth")
pose_detector.load_anchors("./models/mediapipe/anchors/anchors_pose.npy")

pose_regressor = BlazePoseLandmark().to(gpu)
pose_regressor.load_weights("./models/mediapipe/blazes/blazepose_landmark.pth")
